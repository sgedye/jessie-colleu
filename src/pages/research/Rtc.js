    ...
    <section className="page-wrapper">
      ...
      <div className={styles.header}>
        ...
        <div className={styles.mainContent}>
          ...
          <p className={styles.mainText}>In Semester One (2020), we had the privilege of Associate Professor Lorraine Hammond from Edith Cowan University delivering an on-site Professional Learning session entitled “How Explicit Instruction reduces Cognitive Load”. <a href="https://www.cese.nsw.gov.au/publications-filter/cognitive-load-theory-research-that-teachers-really-need-to-understand" target="_blank" rel="noopener noreferrer">Cognitive load theory</a>, from the work of John Sweller, an Emeritus Professor  of Educational Psychology at the University of New South Wales, is an instructional theory based on human cognitive architecture (that is, the cognitive functions that allow us to learn) which looks at the characteristics of working memory and long-term memory, and how teacher instruction can best account for these factors.</p>
          ...
          <p className={styles.mainText}>How do we apply our understanding of how students learn, think and solve problems to classroom instruction? John Sweller says there are a large number of instructional procedures (i.e. ‘effects’) that teachers can employ to lessen extraneous cognitive load.</p>
          <p className={styles.mainText}>Thus, as a follow-up to the workshop, participants split into teams of three (triads) to carry out instructional rounds (based on the research of <a href="https://instructionalcoaching.com/research/" target="_blank" rel="noopener noreferrer">Jim Knight</a>). Teachers took turns to observe each other delivering a lesson in which they were trialling a new evidence-based teaching practice, aiming to reduce the cognitive load in their students. Observers then provided feedback in a supportive environment, enabling teachers to reflect on the benefits of these new practices and their applicability to particular lessons.</p>

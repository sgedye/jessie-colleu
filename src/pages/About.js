...
import auspeld from "../assets/images/about/auspeld.png";
...
function About() {
  return (
    <section className="page-wrapper">
      <h1 className="section-title">Jessica Colleu Terradas:</h1>
      ...
      <div>
        ...
        <div className={styles.linksWrapper}>
          <a className={styles.card} href="https://auspeld.org.au/" target="_blank" rel="noopener noreferrer">
            <img className={styles.cardImg} src={auspeld} alt="Auspeld Logo" />
          </a>
